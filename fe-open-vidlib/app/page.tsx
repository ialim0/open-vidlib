...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col selection:bg-primary/20">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-10 md:pt-16 md:pb-14 border-b bg-gradient-to-b from-muted/30 to-background">
        <div className="container mx-auto px-4 text-center max-w-4xl">
          <div className="space-y-3 mb-8">
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight text-foreground">
              {t.home?.title || "Open VidLib"}
            </h1>
            <p className="text-lg md:text-xl font-medium text-primary">
              {t.home?.subtitle || "Democratizing Learning Through AI"}
            </p>
            <p className="text-sm md:text-base text-muted-foreground max-w-2xl mx-auto">
              {t.home?.tagline || "Empowering learners worldwide with intelligent, interactive educational tools"}
            </p>
          </div>
